...
urlpatterns = [
    ...
    path(
        "admin_actions/make_admin",
        admin.make_new_admin,
        name="admin_actions/make_admin",
    ),
    path(
        "admin_actions/remove_admin",
        admin.delete_admin,
        name="admin_actions/remove_admin",
    ),
    path(
        "admin_actions/delete_user", admin.delete_user, name="admin_actions/delete_user"
    ),
    path(
        "admin_actions/approve_doggiesitter",
        admin.approve_doggiesitter,
        name="admin_actions/approve_doggiesitter",
    ),
