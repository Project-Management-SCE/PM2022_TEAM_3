...
class AccountsProfileForm(forms.ModelForm):
    class Meta:
        model = Accounts
        fields = ('first_name', 'last_name', 'gender', 'date_of_birth', 'id', 'email', 'phone_number', 'address',
                  'is_doggiesitter')
        widgets = {
    ...
    def clean_date_of_birth(self):
        ...
        if age < 18:
            raise forms.ValidationError(
                "Sorry, you have to be at least 18 years old in order to use our site's services.")
        if age > 120:
