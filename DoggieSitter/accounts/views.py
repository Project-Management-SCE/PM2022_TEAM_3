...
class changeAccount(View):
    def get(self, request, user_id):
        ...
        return render(request, "change.html", {"form_user": form, "check": "yes get"})
    ...
    def post(self, request, user_id):
        ...
        if form.is_valid():
            ...
            account.save()
            return render(request, "home.html", {"check": "yes post"})
        return render(request, "change.html", {"form_user": form, "check": "yes post"})
...
def ChangePassword(request):
    ...
    if request.POST.get("new_pass1") == request.POST.get("new_pass2"):
        try:
            validate_password(
                request.POST.get("new_pass1"), user=user, password_validators=None
            )
            ...
            return render(
                ...
                {"result_pass": "Password successfully changed."},
            )
        ...
        return render(
            request,
            "pass_change_done.html",
            {"result_pass": "The 2 passwords doesn't match."},
        )
